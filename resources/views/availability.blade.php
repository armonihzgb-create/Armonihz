...
@section('dashboard-content')
    ...
    <style>
        ...
        .fc-day-today {
            background-color: rgba(108, 63, 197, .03) !important;
        }
        ...
        .fc-daygrid-day:hover:not(.fc-day-past) {
            background: rgba(108, 63, 197, .03) !important;
            cursor: pointer;
        }
        ...
        .av-mode-tab .av-tab-icon {
            font-size: 22px;
            display: block;
            margin-bottom: 4px;
        }

        .av-mode-tab .av-tab-label {
            font-size: 12px;
            font-weight: 700;
            color: #374151;
            display: block;
        ...
        .av-mode-tab.active .av-tab-label {
            color: #6c3fc5;
        }
        ...
        .av-time-form.visible {
            display: block;
            animation: avSlideUp .18s ease;
        }
        ...
        .av-form-group input[type="time"]:focus {
            border-color: #6c3fc5;
            background: #fff;
        }
    ...
    <div class="av-header">
        <div>
            ...
            <p class="av-subtitle">Toca cualquier día para bloquear tiempo. Los clientes verán tu disponibilidad en la app.
            </p>
        </div>
    </div>
    ...
    <div class="av-toolbar">
        <div class="av-legend">
            ...
            <span class="av-legend-item"><span class="av-legend-dot" style="background:#ef4444;opacity:.6;"></span> Horario
                específico</span>
        ...
        <div class="av-modal">
            ...
            <div class="av-modal-body">
                ...
                <div style="margin-top:4px;">
                    <label style="font-size:12px;font-weight:700;color:#475569;display:block;margin-bottom:6px;">Nota
                        (opcional)</label>
