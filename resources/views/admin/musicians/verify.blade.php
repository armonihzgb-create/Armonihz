        ...
        <div class="dashboard-box">
            ...
            @if($musician->verification_status === 'approved')
                <div style="text-align: center; padding: 20px 0;">
                    ...
                    <p style="color: #64748b; font-size: 14px; margin: 0;">Este músico ya ha sido verificado y tiene acceso al sistema.</p>
                </div>
            @elseif($musician->verification_status === 'rejected')
                <div style="text-align: center; padding: 20px 0;">
                    ...
                    <p style="color: #64748b; font-size: 14px; margin: 0; margin-bottom: 15px;">Esperando a que el músico suba un nuevo documento.</p>
                    <div style="text-align: left; background: #f8fafc; padding: 12px; border-radius: 8px; border: 1px solid #e2e8f0;">
                        <span style="display: block; font-size: 12px; font-weight: 600; color: #64748b; margin-bottom: 4px;">Motivo de rechazo actual:</span>
                        <span style="font-size: 14px; color: #1e293b;">{{ $musician->rejection_reason ?? 'No especificado' }}</span>
                    </div>
                </div>
            @else
                @if ($errors->any())
